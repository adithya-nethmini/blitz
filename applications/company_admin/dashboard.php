...
if ($result->num_rows > 0) {
    while ($row2 = $result->fetch_assoc()) {
        ...
        $sql = "SELECT count(*) as total FROM project_list WHERE dept_name = '$dept_name'";
        $result2 = mysqli_query($mysqli, $sql);
        $row = mysqli_fetch_assoc($result2);
        $qry = "SELECT count(*) as sum FROM task WHERE dept_name = '$dept_name'";
        $result3 = mysqli_query($mysqli, $qry);
                ...
                <div class="leave-container1">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $qry = "SELECT id,name,start_date,end_date,status from project_list WHERE dept_name = '$dept_name'";
