...
function fetchPackageLimits($username) {
    global $mysqli;
...
// 	$stmt = $mysqli->prepare("INSERT INTO offers(offer_cover, type, name, date, amount, promocode) VALUES(?,?,?,?,?,?)");
// 	$stmt->bind_param("ssssss", $offer_cover, $type, $name, $date, $amount, $promocode);
// 	$stmt->execute();
// 	if($stmt->affected_rows != 1){
// 		return "An error occurred. Please try again";
