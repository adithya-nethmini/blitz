...
if (isset($_POST['update'])) {
    ...
    if (!$stmt) {
        ...
        echo '<script>window.location.href = "list_employee.php";</script>';
...
// Assuming the query returned a single row, otherwise you may need to handle multiple rows differently

} else {
    // Handle the case when no row is found for the specified employee ID
        ...
        <form class="form-inline" action="" method="post" autocomplete="off" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <table>
                ...
                <td><label for="employeeid">Employee ID:</label></td>
                    <td><input type="text" id="employeeid" placeholder="Enter Employee ID" name="employeeid" value="<?php echo $employeeid; ?>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" id="name" placeholder="Enter Employee's Name" name="name" value="<?php echo $name; ?>"></td>
                    <td><span class="error">*</span>
...
<td>
        <select id="department" name="department" value="<?php echo isset($_POST['department']) ? $_POST['department'] : ''; ?>"required>
...
<td>
        <select id="jobrole" name="jobrole" value="<?php echo isset($_POST['jobrole']) ? $_POST['jobrole'] : ''; ?>"required>
    ...
    <td><input type="text" id="contactno" placeholder="Enter Contact Number" name="contactno" value="<?php echo $contactno; ?>" required>
        ...
        <div class="error"><?php echo @$contactnoErr; ?></div>
                ...
                <tr>
                    ...
                    <td><input type="date" id="jobstartdate" name="jobstartdate"  value="<?php echo $jobstartdate; ?>"></td>
