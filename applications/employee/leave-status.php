    ...
    <section>
        ...
        <?php endif ?>
                    ...
                    <div class="leave-container">
                        ...
                        <div class="header">
                            ...
                            <div class="div-search">
                                <img src="../../views/images/search.png" alt="search" title="Search">
                                <input type="text" id="search-old" onkeyup="searchFunctionOld()" placeholder="Search" title="Search">
                                <img src="../../views/images/filter.png" alt="filter" title="Filter">
                            </div>
                        ...
                        <div class="all-tasks">
                            ...
                            <table id="table-old" class="task-tbl">
                                    ...
                                    if ($result == TRUE) :
                                        ...
                                        if ($count_rows > 0) :
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) :
                                                ...
                                                $sql = ("SELECT * FROM e_leave WHERE name = '$user' AND MONTH(applied_date)!=MONTH(CURRENT_TIMESTAMP) ");
        ...
        <?php endif ?>
                            ...
                            <script>
                                ...
                                function searchFunctionOld() {
                                    var input, filter, table, tr, td, i;
                                    input = document.getElementById("search-old");
                                    filter = input.value.toUpperCase();
                                    table = document.getElementById("table-old");
                                    tr = table.getElementsByTagName("tr");
                                    for (var i = 0; i < tr.length; i++) {
                                        var tds = tr[i].getElementsByTagName("td");
                                        var flag = false;
