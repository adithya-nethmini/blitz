...
$sql = "UPDATE e_leave SET status = 'Canceled' WHERE id = ?";
...
$sql2 = "INSERT INTO notification(notification_name, notification_description, notification_type, username, status) VALUES('Leave Cancelled', '$leave_type', 1, '$name', 'unseen')";
