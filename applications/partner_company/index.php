...
<section id="section-landing-1">
 ...
 <!-- ?php if (isset($_SESSION['user'])) : ? -->
  <div class="div-loyalty">
    ...
    <table>
      <tr>
        <td><img style="border-radius: 50%;transform:scale(0.5)" src="images/jessica.jpg" alt=""></td>
        <td><img style="border-radius: 50%;transform:scale(0.5)" src="images/emp2.png" alt=""></td>
        <td><img style="border-radius: 50%;transform:scale(0.5)" src="images/emp3.png" alt=""></td>
        <td><img style="border-radius: 50%;transform:scale(0.5)" src="images/emp4.png" alt=""></td>
        <td><img style="border-radius: 50%;transform:scale(0.5)" src="images/emp6.jpg" alt=""></td>
      </tr>
      <tr class="rrr">
